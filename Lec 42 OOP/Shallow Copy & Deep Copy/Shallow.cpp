...
int main(){
    ...
    cout<< " Changes occur in hero2 also"<< endl;
    hero2.print();  // Ab yha hero2 bhi print kara rhe to yha arpit aana chahiye tha par yha bhi changes ho ja rha hai or srpit print ho rha 
}